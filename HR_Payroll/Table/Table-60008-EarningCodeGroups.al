table 60008 "Earning Code Groups"
{
    DrillDownPageID = "Earning Code Groups";
    LookupPageID = "Earning Code Groups";
    ...
    fields
    {
        ...
        {
            TableRelation = "Insurance Service Provider"."Insurance Provider Code";
        }
    ...
    keys
    {
        key(Key1; "Earning Code Group", "Grade Category")
        {
            Clustered = true;
        }
    }
